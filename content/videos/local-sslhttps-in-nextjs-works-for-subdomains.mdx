...
```text title="config/ssl/certificates/domains.ext"
...
See the [full subdomain configuration](https://github.com/sashkode/sashkode/blob/trunk/config/ssl/next-subdomains.ts) for details or read the [How to Build Multi-Tenant Apps in Next.js • Without Middleware?
](http://sashkode.dev/how-to-build-multi-tenant-apps-in-next-js-without-middleware) article.
