...
The [`database/resource-id.ts`](https://github.com/sashkode/best-database-ids/blob/main/database/resource-id.ts) module handles ID generation, encoding, and decoding.
...
The [`resourceId`](https://github.com/sashkode/best-database-ids/blob/main/database/resource-id.ts#L126-L137) custom type brings this all together in Drizzle schemas:
...
The [seed script](https://github.com/sashkode/best-database-ids/blob/main/database/seed.ts) shows real-world usage:
...
1. Copy [`database/resource-id.ts`](https://github.com/sashkode/best-database-ids/blob/main/database/resource-id.ts) to your codebase
