...
In late 2025, **Cursor acquired Graphite**, signaling that stacked diffs and AI coding are converging. The future: your IDE and your PR review workflow are one system.

GitHub is also [building native stacked diffs](https://github.com/features/stack), so this pattern will become mainstream regardless of tooling choice.
...
Tools like [ClickUp Agents](https://clickup.com/ai) and Linear's AI features are early examples, but they're not yet code-aware in the way developer tools are.
...
- **[Drizzle ORM](https://orm.drizzle.team/)** — Type-safe SQL queries (1.0 coming in 2026)
